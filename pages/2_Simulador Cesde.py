...
def filtro3():
    ...
    resultado = df[(df['NIVEL'] == nivel) & (df['HORARIO'] == horario)]
...
def filtro4():
    ...
    resultado = df[(df['SUBMODULO'] == submodulo) & (df['DOCENTE'] == docente)]
...
filtros = [
    ...
    "Notas por nivel y horario",
    "Notas por submódulo y docente"
]
